...
export interface LotteryDraw {
   ...
   * เก็บไว้เป็นบันทึกภายในเท่านั้น — หน้าเว็บแสดงผลทันทีทั้งสองสถานะ ไม่มีป้าย "รอการตรวจสอบซ้ำ" แล้ว
   * (ตัดสินใจ 20 ก.ย. 2569: ข้อมูลมาจาก API ของสำนักงานสลากฯ โดยตรง ไม่ต้องรอคนตรวจซ้ำ)
   */
  status: DrawStatus;
}
