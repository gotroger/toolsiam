...
export const CHINESE_ZODIAC: ChineseZodiacAnimal[] = [
  { id: 'rat', name: 'ชวด (หนู)', nameEn: 'Rat', traits: ['ไหวพริบดี', 'ประหยัด', 'ปรับตัวเก่ง'], summary: 'ตามความเชื่อ คนปีชวดมีไหวพริบและมองเห็นโอกาสก่อนคนอื่น เก่งเรื่องการเก็บออมและวางแผนล่วงหน้า' },
  { id: 'ox', name: 'ฉลู (วัว)', nameEn: 'Ox', traits: ['อดทน', 'ขยัน', 'หนักแน่น'], summary: 'ตามความเชื่อ คนปีฉลูทำงานหนักอย่างเงียบ ๆ และเชื่อถือได้ แต่เปลี่ยนความคิดยากเมื่อตัดสินใจไปแล้ว' },
  { id: 'tiger', name: 'ขาล (เสือ)', nameEn: 'Tiger', traits: ['กล้าหาญ', 'มั่นใจ', 'ชอบท้าทาย'], summary: 'ตามความเชื่อ คนปีขาลกล้าเสี่ยงและไม่ยอมแพ้ มักเป็นผู้นำโดยธรรมชาติแต่ต้องระวังความหุนหัน' },
  { id: 'rabbit', name: 'เถาะ (กระต่าย)', nameEn: 'Rabbit', traits: ['สุภาพ', 'รอบคอบ', 'รักสงบ'], summary: 'ตามความเชื่อ คนปีเถาะละมุนละม่อมและเข้ากับคนง่าย เลี่ยงความขัดแย้งและมักได้รับความเมตตาจากผู้ใหญ่' },
  { id: 'dragon', name: 'มะโรง (งูใหญ่)', nameEn: 'Dragon', traits: ['มีบารมี', 'ทะเยอทะยาน', 'มีพลัง'], summary: 'ตามความเชื่อ คนปีมะโรงโดดเด่นและมีพลังดึงดูด มักได้รับโอกาสใหญ่แต่ต้องระวังความมั่นใจเกินตัว' },
  { id: 'snake', name: 'มะเส็ง (งูเล็ก)', nameEn: 'Snake', traits: ['ลึกซึ้ง', 'ช่างสังเกต', 'สุขุม'], summary: 'ตามความเชื่อ คนปีมะเส็งคิดก่อนพูดและอ่านสถานการณ์ขาด มักเก็บความคิดไว้กับตัวจนคนอื่นคาดเดายาก' },
  { id: 'horse', name: 'มะเมีย (ม้า)', nameEn: 'Horse', traits: ['รักอิสระ', 'กระตือรือร้น', 'เข้าสังคมเก่ง'], summary: 'ตามความเชื่อ คนปีมะเมียมีพลังงานสูงและไม่ชอบอยู่นิ่ง เข้ากับคนได้ทุกวงแต่เบื่อกรอบเร็ว' },
  { id: 'goat', name: 'มะแม (แพะ)', nameEn: 'Goat', traits: ['อ่อนโยน', 'มีศิลปะ', 'เห็นใจคนอื่น'], summary: 'ตามความเชื่อ คนปีมะแมมีความละเอียดอ่อนทางความรู้สึกและรสนิยมดี ทำงานสร้างสรรค์ได้ดีกว่างานที่ต้องแข่งขัน' },
  { id: 'monkey', name: 'วอก (ลิง)', nameEn: 'Monkey', traits: ['ฉลาด', 'ยืดหยุ่น', 'มีอารมณ์ขัน'], summary: 'ตามความเชื่อ คนปีวอกแก้ปัญหาเฉพาะหน้าเก่งและเรียนรู้ไว มักหาทางออกที่คนอื่นนึกไม่ถึง' },
  { id: 'rooster', name: 'ระกา (ไก่)', nameEn: 'Rooster', traits: ['ตรงไปตรงมา', 'มีระเบียบ', 'ขยัน'], summary: 'ตามความเชื่อ คนปีระกาพูดตรงและใส่ใจรายละเอียด ทำงานเป็นระบบแต่บางครั้งเข้มงวดกับคนรอบข้าง' },
  { id: 'dog', name: 'จอ (สุนัข)', nameEn: 'Dog', traits: ['ซื่อสัตย์', 'ยุติธรรม', 'ปกป้องคนที่รัก'], summary: 'ตามความเชื่อ คนปีจอให้ค่ากับความซื่อสัตย์และความถูกต้อง เป็นเพื่อนที่พึ่งพาได้แต่ไว้ใจคนช้า' },
  { id: 'pig', name: 'กุน (หมู)', nameEn: 'Pig', traits: ['ใจดี', 'จริงใจ', 'มีน้ำใจ'], summary: 'ตามความเชื่อ คนปีกุนใจกว้างและไม่คิดร้ายกับใคร มักมีกินมีใช้แต่ต้องระวังการถูกเอาเปรียบ' },
];
