 ...
 *
 * ⚠️ แหล่งของสำนักงานประกันสังคมขัดกันเอง: หน้า "เงินสมทบและการชำระเงิน"
 * (sso.go.th/wpr/main/general/เงินสมทบและการชำระเงิน_singleview_detail_1_193_0/438_438)
 * ยังเขียนเพดาน 15,000 บาท ขณะที่หน้าสิทธิประโยชน์ซึ่งอัปเดต 20 ส.ค. 2569 ระบุ 17,500 บาท
 * ตั้งแต่ 1 ม.ค. 2569 — ยึดหน้าหลัง เพราะใหม่กว่าและระบุวันมีผลชัดเจน
 *
 * ⚠️ ยังไม่ได้เห็นตัวกฎกระทรวงจากราชกิจจานุเบกษาโดยตรง (เว็บกัน bot)
 * ถ้าต้องการ sourceUrl ระดับกฎหมาย ต้องให้คนเปิดเองแล้วบันทึกเลขเล่ม/ตอน/หน้า
 */
