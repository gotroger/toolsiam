 ...
 *
 * ✅ verify เมื่อ 8 ก.ย. 2569 (VF1) — ตัวกฎกระทรวงมีจริงและมีผลแล้ว:
 * "กฎกระทรวงกำหนดค่าจ้างขั้นต่ำและขั้นสูงที่ใช้เป็นฐานในการคำนวณเงินสมทบ
 * ของผู้ประกันตนตามมาตรา 33 พ.ศ. 2568" ประกาศราชกิจจานุเบกษา 12 ธ.ค. 2568
 * มีผล 1 ม.ค. 2569 → เพดาน 17,500 บาท เงินสมทบสูงสุด 875 บาท/เดือน
 * ยืนยันจาก ศูนย์บริการข้อมูลภาครัฐ gcc.go.th และข่าว สปส. ที่ตรงกัน
 *
 * ⚠️ **ยังไม่ได้เลขเล่ม/ตอน/หน้า** ของกฎกระทรวงฉบับนี้ — ระบบค้นหาของ
 * ratchakitcha.soc.go.th ไม่รับ keyword ผ่าน URL และตัวเว็บมี Cloudflare กัน bot
 * ต้องให้คนเปิดเว็บแล้วค้นด้วยมือ แล้วเติมลงใน SOURCES ด้านล่าง
 *
 * หมายเหตุขอบเขตของระยะแรก: หลายแหล่งเขียนช่วงไม่ตรงกัน (บ้างว่าถึงปี 2571
 * บ้างว่าถึง 31 ก.ค. 2571) — **จงใจไม่ใส่วันสิ้นสุด** เพราะยังไม่เห็นตัวกฎกระทรวง
 */
...
export const SOCIAL_SECURITY_SOURCE: RateSource = {
  ...
  sourceName: 'สำนักงานประกันสังคม (sso.go.th)',
