...
export const INCOME_TAX_SOURCES: RateSource[] = [
  {
    effectiveFrom: 'ปีภาษี 2567–2569',
    lastVerifiedAt: '2026-09-09',
    sourceName: 'กฎกระทรวง ฉบับที่ 395 — Thai ESG',
    sourceUrl: 'https://www.rd.go.th/fileadmin/user_upload/kormor/newlaw/mr395.pdf',
    summary: 'Thai ESG ไม่เกิน 30% ของเงินได้ สูงสุด 300,000 บาท ถือไม่น้อยกว่า 5 ปี',
  },
  {
    effectiveFrom: 'มาตรา 47(1)(ฌ)',
    lastVerifiedAt: '2026-09-09',
    sourceName: 'กรมสรรพากร — สิทธิลดหย่อนประกันสังคม',
    sourceUrl: 'https://www.rd.go.th/60061.html',
    summary:
      'คำถาม 2 และ 4: ลดหย่อนตามจ่ายจริงแต่ไม่เกินที่กฎหมายประกันสังคมกำหนด; ตัวเลข 9,000 ในตัวอย่างเก่าไม่ใช่เพดานอิสระของปี 2569',
  },
  {
  ...
  },
  {
    ...
    summary:
      'เงินได้ประเภทที่ 1 และ 2 หักค่าใช้จ่าย 50% แต่ไม่เกิน 100,000 บาท · ลดหย่อนส่วนตัว 60,000 · คู่สมรสไม่มีเงินได้ 60,000 · บุตร 30,000/คน (คนที่ 2 ขึ้นไปที่เกิดตั้งแต่ปี 2561 = 60,000) · เงินสมทบประกันสังคมตามจ่ายจริงภายในกฎหมายประกันสังคม (ปี 2568: 9,000 / ปี 2569: 10,500) · กลุ่มการออมเพื่อเกษียณรวมกันไม่เกิน 500,000',
  },
];
