...
/**
 * อัตราภาษีหัก ณ ที่จ่ายที่ใช้บ่อย (ภ.ง.ด.3/53) — เฉพาะเงินได้ที่ออกใบกำกับภาษีพร้อม VAT ได้
 *
 * จงใจไม่ใส่เงินปันผล (10%) และดอกเบี้ย (15%): สองประเภทนี้ไม่อยู่ในบังคับ VAT
 * ถ้าอยู่ในเครื่องมือนี้ ระบบจะบวก VAT 7% เข้าไปซึ่งผิด และอัตรานั้นเป็นอัตราของผู้รับที่เป็นบุคคลธรรมดาเท่านั้น
 */
