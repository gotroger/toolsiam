...
export const vatWhtMeta: ToolMeta = {
  ...
  faq: [
    ...
    {
      q: 'อยากคำนวณภาษีหัก ณ ที่จ่ายอย่างเดียว ทำที่ไหน',
      a: 'ใช้เครื่องมือคำนวณภาษีหัก ณ ที่จ่ายที่ /tools/wht-calculator ซึ่งแยกอัตราตามประเภทเงินได้ให้ครบ และคำนวณย้อนกลับจากยอดที่ได้รับจริงไปหาค่าบริการที่ต้องเรียกเก็บได้ด้วย หน้านี้เน้นที่ VAT เป็นหลัก',
    },
    {
