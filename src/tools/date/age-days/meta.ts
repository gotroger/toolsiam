...
export const ageDaysMeta: ToolMeta = {
  ...
  faq: [
    { q: 'กรอกปี พ.ศ. ลงในช่องวันที่ได้เลยไหม', a: 'ไม่ได้ ช่องวันที่ใช้ปฏิทินของเบราว์เซอร์ซึ่งเป็นปี ค.ศ. ให้ลบ 543 ก่อน เช่น พ.ศ. 2533 คือ ค.ศ. 1990 เมื่อเลือกแล้วบรรทัด "ตรงกับ พ.ศ. …" ใต้ช่องจะยืนยันให้ว่าตรงปีไทยที่ต้องการ ถ้าต้องการแปลงปี พ.ศ./ค.ศ. โดยตรง ใช้เครื่องมือแปลงปี พ.ศ. ค.ศ. ที่ /t/thai-year-convert' },
