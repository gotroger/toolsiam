...
const summaries: Record<string, [string, string]> = {
  ...
  'image-to-text': ['แปลงรูปเป็นข้อความ (OCR)', 'ดึงข้อความไทยและอังกฤษจากรูป'],
  'image-rotate': ['หมุนและกลับด้านรูปภาพ', 'หมุน 90 180 270 องศา และกลับด้าน'],
  'random-picker': ['สุ่มชื่อ จับฉลาก', 'สุ่มผู้โชคดีจากรายชื่อ ตรวจย้อนหลังได้'],
  'spin-wheel': ['วงล้อสุ่ม', 'ใส่ตัวเลือกแล้วหมุนให้ช่วยตัดสินใจ'],
  'random-number': ['สุ่มตัวเลข', 'สุ่มเลขในช่วง ทอยลูกเต๋า และหัวก้อย'],
  'random-groups': ['สุ่มแบ่งกลุ่ม', 'แบ่งรายชื่อเป็นกลุ่มหรือทีมโดยสุ่ม'],
  'password-generator': ['สุ่มรหัสผ่าน', 'สร้างรหัสผ่านที่เดายาก ในเบราว์เซอร์คุณ'],
  'lucky-number': ['สุ่มเลขนำโชค', 'สุ่มเลข 2 ตัว 3 ตัว เพื่อความบันเทิง'],
