...
export function Alert({
  ...
  const styles =
    tone === 'danger' ? 'border-red-200 bg-red-50 text-red-900' : 'border-amber-200 bg-amber-50 text-amber-900';
  ...
  return (
    <div
      ...
      className={`flex items-start gap-2 rounded-[10px] border p-3 text-sm ${styles}`}
    >
      <svg
