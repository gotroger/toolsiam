...
export const TOOL_GLYPHS: Record<string, string> = {
  ...
  /* สุ่มและตัดสินใจ */
  /** กล่องจับฉลากมีสลากโผล่ */
  'random-picker': 'M4 10h16v10H4V10Zm2-4.5h12L20 10H4l2-4.5ZM12 13v4m-2-2h4',
  /** วงล้อมีเข็มชี้ด้านบน */
  'spin-wheel': 'M12 5.5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Zm0 0v7.5l6.4 3.7M12 13 5.6 16.7M12 2l2.2 3.2h-4.4L12 2Z',
  /** ลูกเต๋าสองลูกซ้อน */
  'random-number': 'M3.5 8.6 9 3.1l5.5 5.5L9 14.1 3.5 8.6Zm5.4.1h.01M10.5 11.5h10v9h-10v-9Zm2.5 2.5h.01m5 4h.01',
  /** คนสามกลุ่ม */
  'random-groups':
    'M6.2 5.4a1.9 1.9 0 1 1 0 3.8 1.9 1.9 0 0 1 0-3.8Zm11.6 0a1.9 1.9 0 1 1 0 3.8 1.9 1.9 0 0 1 0-3.8ZM12 14.6a1.9 1.9 0 1 1 0 3.8 1.9 1.9 0 0 1 0-3.8ZM2.8 13.4c0-2 1.5-3.2 3.4-3.2s3.4 1.2 3.4 3.2m4.8 0c0-2 1.5-3.2 3.4-3.2s3.4 1.2 3.4 3.2M8.6 22.6c0-2 1.5-3.2 3.4-3.2s3.4 1.2 3.4 3.2',
  /** กุญแจมีจุดรหัสบนตัวล็อก */
  'password-generator': 'M7.2 10.4V7.8a4.8 4.8 0 0 1 9.6 0v2.6M5 10.4h14V20H5v-9.6Zm4.2 4.4h.01m2.8 0h.01m2.8 0h.01',
  /** ลูกบอลเลขในวงกลม */
  'lucky-number':
    'M12 3.4a8.6 8.6 0 1 1 0 17.2 8.6 8.6 0 0 1 0-17.2Zm-2.6 5.4h1.9v6.4m3-6.4h1.8a1.6 1.6 0 0 1 0 3.2h-1.3h1.3a1.6 1.6 0 0 1 0 3.2h-1.8',
};
