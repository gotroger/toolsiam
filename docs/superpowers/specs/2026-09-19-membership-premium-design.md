# สมาชิก Google + พรีเมียม (29 บาท/30 วัน) — ดีไซน์
...
2. ขายสมาชิกพรีเมียมราคา 29 บาทต่อ 30 วัน (เดิม 19 ปรับ 21 ก.ย. 2569) ชำระผ่าน QR PromptPay (Beam Checkout)
...
| ราคา               | `PREMIUM_PRICE_SATANG` ใน `src/lib/plan-limits.ts` (29 บาท = 2,900 สตางค์) ต่อ 30 วัน                                            |
